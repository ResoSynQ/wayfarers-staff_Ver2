/**
 * 旅人の杖と救いの泉 Ver 2.0.22-Topo
 * 安定版ベース + MapTiler Topo 統合
 */
...
map.on('overlayadd', function(e) {
    if (e.name.includes('喫茶店') && !restaurantWarningShown) { alert("飲食店データは最大で10mの誤差があることがあります。"); restaurantWarningShown = true; }
    if ((e.name.includes('トレイル') || e.name.includes('自然歩道')) && !advanceWarningShown) { alert("【上級者向け警告】\\n難易度の高いルートが含まれます。"); advanceWarningShown = true; }
});
